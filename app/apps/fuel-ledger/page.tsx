...
export default function FuelLedgerPage() {
  return <main className="fuel-page">
    <header className="fuel-nav"><a href="/" className="fuel-brand" aria-label="MindVector home"><img className="fuel-logo" src="/fuel-ledger-mark.svg" alt="" />FuelLedger</a><nav aria-label="FuelLedger navigation"><a href="#product">Product</a><a href="#operations">Operations</a><a href="#intelligence">Intelligence</a><a href="#pricing">Pricing</a></nav><a className="fuel-nav-cta" href="tel:+918977506454">Talk to us <span>↗</span></a></header>
    <section className="fuel-hero" id="product">
      <div className="fuel-hero-copy"><p className="fuel-eyebrow"><span /> The operating system for petrol pumps</p><h1>Every shift.<br /><em>Under control.</em></h1><p>FuelLedger runs the daily reality of a petrol pump—from people and fuel stock to collections, accounting and every revenue line—so owners know exactly how the business is doing.</p><div className="fuel-actions"><a className="fuel-primary" href="tel:+918977506454">Speak with us <b>→</b></a><a className="fuel-link" href="#operations">Explore the OS <span>↓</span></a></div></div>
    ...
    <section className="fuel-pricing" id="pricing"><div className="pricing-heading"><p className="fuel-eyebrow"><span /> Recommended plan</p><h2>FuelLedger<br /><em>Complete</em></h2><p>Everything an owner needs to run a petrol pump with clarity and control.</p></div><article className="pricing-card"><div className="pricing-card-head"><div><img className="fuel-logo" src="/fuel-ledger-mark.svg" alt="" /><p>FUELLEDGER COMPLETE</p></div><a href="tel:+918977506454">Launch pricing <b>↗</b></a></div><div className="price-options"><div><p>Pay monthly</p><strong>₹1,499</strong><span>per petrol pump / month</span></div><div className="annual"><p>Pay annually <b>About 2 months free</b></p><strong>₹14,999</strong><span>per petrol pump / year</span></div></div><div className="early-adopter"><span>✦</span><div><b>EARLY-ADOPTER FIRST YEAR</b><p>Includes assisted setup. Renewal moves to the standard annual price.</p></div><strong>₹11,999 <small>per petrol pump</small></strong></div><ul className="feature-list">{features.map((feature) => <li key={feature}><span>✓</span>{feature}</li>)}</ul><a className="pricing-contact" href="tel:+918977506454">Contact us · 89775 06454 <span>↗</span></a><p className="price-note">Prices exclude applicable GST. No transaction fee is charged by FuelLedger.</p></article></section>
    <section className="fuel-cta"><p className="fuel-eyebrow"><span /> Built for the daily reality of a pump</p><h2>Ready to run a<br /><em>tighter outlet?</em></h2><a href="tel:+918977506454">Call 89775 06454 <span>→</span></a></section><footer className="fuel-footer"><a href="/" className="fuel-brand"><img className="fuel-logo" src="/fuel-ledger-mark.svg" alt="" />FuelLedger</a><p>© 2026 FuelLedger</p><a href="/">A MindVector product ↗</a></footer>
  </main>;
}
